...
<div class="container">
    ...
    <form action="" class="container__form" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" id="postal_code" name="postal_code" class="form-group__input" value="">
        </div>
        <div class="form-group">
            <label for="address" class="form-group__label">住所</label>
            <input type="text" id="address" name="address" class="form-group__input" value="">
        </div>
        <div class="form-group">
            <label for="building_name" class="form-group__label">建物名</label>
            <input type="text" id="" name="building_name" class="form-group__input" value="">
        </div>
